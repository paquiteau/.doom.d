...
;; Strip all configs from doom-emacs 
...
(use-package! org-gtd
  ...
  (org-gtd-areas-of-focus '("home" "work" "scouts" "health" "nous"))

  :config
  (org-edna-mode)
  ;; Add org-gtd files to your agenda (in :config so org-gtd-directory is defined)
  (setq org-gtd-additional-inbox-files `(,(expand-file-name "~/org/gtd/inbox-phone.org")))
...
(with-eval-after-load 'org-modern
  (setq org-modern-todo-faces
        '(("TODO" :background "orange" :foreground "black" :weight bold)
          ("NEXT" :background "green" :foreground "white" :weight bold)
          ("WAIT" :background "blue" :foreground "white" :weight bold))
  )
