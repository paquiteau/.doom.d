...
(custom-set-faces!
  ...
  '(mode-line :family "Noto" :height 0.9)
  '(mode-line-inactive :family "Noto" :height 0.9)
...
(after! lsp-mode
  ...
  (defcustom-lsp lsp-pylsp-plugin-ruff-linelength 10
    "enable ruff"
    :group 'lsp-pylsp
    :type 'vector
    :lsp-path "pylsp.plugins.ruff.lineLength")
