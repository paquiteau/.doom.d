...
;; Use tecosaur development branch
 (package! org :recipe
   ...
   :pin "a7579581f91866d06d5a1e66ac59f9b57fb1324d"
   )
(package! ox-gfm)
#+end_src
#+begin_src emacs-lisp
...
(use-package! lsp-ltex
  ...
  :init
  (setq lsp-ltex-version "latest")
  (setq lsp-ltex-languagetool-http-server-uri "https://api.languagetoolplus.com")
  (setq lsp-ltex-languagetool-org-username (auth-source-pass-get "login" "web/languagetool.org"))
  (setq lsp-ltex-languagetool-org-api-key (auth-source-pass-get "api_key" "web/languagetool.org"))
  (setq lsp-ltex-server-store-path (expand-file-name "ltex-ls-plus" lsp-server-install-dir ))
  :config
  (setq lsp-ltex-enabled t)
  (setq lsp-ltex-mother-tongue "fr-FR")
  (setq lsp-ltex-completion-enabled nil)
  (setq lsp-ltex-diagnostic-severity "hint")
  )
(after! tex
