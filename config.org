...
(setq
 ...
 doom-font (font-spec :family "Iosevka Nerd Font" :size 14.0)
 doom-variable-pitch-font (font-spec :family "Iosevka Nerd Font" :size 14.0)
 doom-big-font (font-spec :family "Iosevka Nerd Font" :size 24.0)
...
;; Use tecosaur development branch
 (package! org :recipe
   ...
   :pin  "42f5c403d381da1adb6dbdd080ffd4efc94b3f23")
#+end_src
** Global config
...
(after! org-roam
  (add-to-list 'org-roam-buffer-postrender-functions (lambda () (org-latex-preview--preview-region (point-min) (point-max))) t)
  )
#+end_src
...
** TODO Auto updating of bibliography
