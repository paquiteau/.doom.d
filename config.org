...
(setq
 ...
 doom-font (font-spec :family "Iosevka Nerd Font" :weight 'regular :size 18)
 doom-variable-pitch-font (font-spec :family "LM Sans10" :size 12)
 doom-big-font (font-spec :family "Iosevka Nerd Font" :weight 'regular :size 30)
 doom-serif-font (font-spec :family "Iosevka Nerd Font" :weight 'regular :size 18)
