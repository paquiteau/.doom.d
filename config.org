...
[Service]
Type=forking
ExecStart=sh -c 'emacs --daemon --with-x-toolkit=lucid && emacsclient -c --eval "(delete-frame)"'
...
#+begin_src emacs-lisp
(defvar pac-bibliography "~/Zotero/Library.bib")
...
(after! lsp-mode
  (setq lsp-pylsp-plugins-autopep8-enabled t
        lsp-pylsp-plugins-flake8-ignore "E121,E123,E126,E226,E24,E704,E402,E731,E722,E741,W503,W504,W605,D105"
        lsp-pylsp-plugins-flake8-max-line-length 105
        lsp-pylsp-plugins-pydocstyle-add-ignore "D105"))
...
(map! :after python
      :map python-mode-map
      :localleader "n" 'numpydoc-generate)
#+end_src
