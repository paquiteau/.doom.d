...
;; Use tecosaur development branch
 (package! org :recipe
   ...
   :pin  "c07cf4fbca96f25f21f085224ed737cd0095acbc")
#+end_src
** Global config
...
(after! citar
  (setq citar-org-roam-subdir "bib"
        citar-bibliography '("/home/pac/org/library.bib")
        citar-library-paths '("/home/pac/Zotero/")
        citar-notes-paths  '("/home/pac/org/roam/bib/")
        citar-symbols
...
(map! :map copilot-mode-map
      :i "M-C-<next>" #'copilot-next-completion
      :i "M-C-<prior>" #'copilot-previous-completion
      :i "M-C-<right>" #'copilot-accept-completion-by-word
      :i "M-C-<down>" #'copilot-accept-completion-by-line
                )

(map! :map global-map
      :i "M-C-<return>" #'rk/copilot-complete-or-accept
      :n "M-C-<escape>" #'rk/copilot-change-activation
      )
