...
Exec=/home/pac/.local/bin/e
Icon=/home/pac/.doom.d/doom-icons.png
Type=Application
Terminal=false
...
(setq org-roam-directory "/home/pac/org/roam/"
      org-roam-dailies-directory "/home/pac/org/roam/journal/")
...
#+begin_src emacs-lisp
(defvar +org-roam-image-directory "/home/pac/org/roam/images/")
...
(defun pac/screenshot-to-roam ()
  ...
  (interactive)
  (let ((filename (pac/get-new-filename (concat +org-roam-image-directory (org-id-get) ".png"))))
...
#+begin_src emacs-lisp
(setq
      org-agenda-files '(+org-calendar-file)
